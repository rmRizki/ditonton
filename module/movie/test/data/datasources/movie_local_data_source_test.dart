...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when insert to database is success',
      ...
      when(mockDatabaseHelper.insertWatchlist(
              MOVIE_TABLE, testMovieTable.toJson()))
  ...
  group('remove watchlist', () {
    test('should return success message when remove from database is success',
        () async {
      // arrange
      when(mockDatabaseHelper.removeWatchlist(MOVIE_TABLE, testMovieTable.id))
          .thenAnswer((_) async => 1);
      // act
  ...
  group('Get Movie Detail By Id', () {
    ...
    test('should return Movie Detail Table when data is found', () async {
      // arrange
      when(mockDatabaseHelper.getDataById(MOVIE_TABLE, tId))
  ...
  group('get watchlist movies', () {
    test('should return list of MovieTable from database', () async {
      // arrange
      when(mockDatabaseHelper.getWatchlist(MOVIE_TABLE))
          .thenAnswer((_) async => [testMovieMap]);
      // act
